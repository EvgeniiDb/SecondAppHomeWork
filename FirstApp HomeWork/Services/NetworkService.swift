...
class NetworkService {
    ...
    func getUserFriends(completion: @escaping (Result<[ItemsFriend], Error>) -> Void ) {
    ...
    func getUserGroups(completion: @escaping (Result<[ItemsGroup], Error>) -> Void ) {
        var constructor = urlConstructor
    ...
    func getGlobalGroup(groupSearch: String, completion: @escaping (Result<[ItemsGroup], Error>) -> Void ) {
        var constructor = urlConstructor
    ...
    func getPhotos(friendId: String, completion: @escaping (Result<[ItemsPhotoArray], Error>) -> Void ) {
        var constructor = urlConstructor
